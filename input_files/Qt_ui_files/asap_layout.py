...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        QWidget.setTabOrder(self.tabWidget, self.lineEdit_clients_client_name)
        QWidget.setTabOrder(self.lineEdit_clients_client_name, self.comboBox_clients_first_year)
        QWidget.setTabOrder(self.comboBox_clients_first_year, self.lineEdit_clients_person_name)
        QWidget.setTabOrder(self.lineEdit_clients_person_name, self.lineEdit_clients_address)
        QWidget.setTabOrder(self.lineEdit_clients_address, self.lineEdit_clients_postal_code_and_city)
        QWidget.setTabOrder(self.lineEdit_clients_postal_code_and_city, self.lineEdit_clients_standard_rate_during_day)
        QWidget.setTabOrder(self.lineEdit_clients_standard_rate_during_day, self.lineEdit_clients_standard_rate_for_shifts)
        QWidget.setTabOrder(self.lineEdit_clients_standard_rate_for_shifts, self.lineEdit_clients_standard_compensation_for_commute)
        QWidget.setTabOrder(self.lineEdit_clients_standard_compensation_for_commute, self.lineEdit_clients_standard_compensation_for_driving_during_work)
        QWidget.setTabOrder(self.lineEdit_clients_standard_compensation_for_driving_during_work, self.pushButton_add_client)
        QWidget.setTabOrder(self.pushButton_add_client, self.pushButton_clients_clear_fields)
        QWidget.setTabOrder(self.pushButton_clients_clear_fields, self.comboBox_clients_query_start_year)
        QWidget.setTabOrder(self.comboBox_clients_query_start_year, self.comboBox_clients_query_stop_year)
        QWidget.setTabOrder(self.comboBox_clients_query_stop_year, self.radioButton_clients_query_using_years)
        QWidget.setTabOrder(self.radioButton_clients_query_using_years, self.radioButton_clients_query_return_all)
        QWidget.setTabOrder(self.radioButton_clients_query_return_all, self.radioButton_clients_sort_by_year_and_index)
        QWidget.setTabOrder(self.radioButton_clients_sort_by_year_and_index, self.radioButton_clients_sort_by_client_name)
        QWidget.setTabOrder(self.radioButton_clients_sort_by_client_name, self.pushButton_clients_run_query)
        QWidget.setTabOrder(self.pushButton_clients_run_query, self.pushButton_clients_export_query_results)
        QWidget.setTabOrder(self.pushButton_clients_export_query_results, self.pushButton_clients_overwrite)
        QWidget.setTabOrder(self.pushButton_clients_overwrite, self.pushButton_clients_delete)
        QWidget.setTabOrder(self.pushButton_clients_delete, self.tableView_clients_query)
        QWidget.setTabOrder(self.tableView_clients_query, self.comboBox_times_client_name)
        QWidget.setTabOrder(self.comboBox_times_client_name, self.lineEdit_times_date)
        QWidget.setTabOrder(self.lineEdit_times_date, self.pushButton_times_fill_in_today)
        QWidget.setTabOrder(self.pushButton_times_fill_in_today, self.pushButton_times_increment_by_one_week)
        QWidget.setTabOrder(self.pushButton_times_increment_by_one_week, self.comboBox_times_type_of_hours)
        QWidget.setTabOrder(self.comboBox_times_type_of_hours, self.comboBox_times_start_time)
        QWidget.setTabOrder(self.comboBox_times_start_time, self.comboBox_times_stop_time)
        QWidget.setTabOrder(self.comboBox_times_stop_time, self.lineEdit_commute_km)
        QWidget.setTabOrder(self.lineEdit_commute_km, self.lineEdit_distance_during_work_km)
        QWidget.setTabOrder(self.lineEdit_distance_during_work_km, self.pushButton_add_working_day)
        QWidget.setTabOrder(self.pushButton_add_working_day, self.pushButton_times_clear_fields)
        QWidget.setTabOrder(self.pushButton_times_clear_fields, self.comboBox_times_query_start_month)
        QWidget.setTabOrder(self.comboBox_times_query_start_month, self.comboBox_times_query_start_year)
        QWidget.setTabOrder(self.comboBox_times_query_start_year, self.comboBox_times_query_stop_month)
        QWidget.setTabOrder(self.comboBox_times_query_stop_month, self.comboBox_times_query_stop_year)
        QWidget.setTabOrder(self.comboBox_times_query_stop_year, self.comboBox_times_query_client_name)
        QWidget.setTabOrder(self.comboBox_times_query_client_name, self.radioButton_times_query_dates_only)
        QWidget.setTabOrder(self.radioButton_times_query_dates_only, self.radioButton_times_query_client_only)
        QWidget.setTabOrder(self.radioButton_times_query_client_only, self.radioButton_times_query_dates_and_client)
        QWidget.setTabOrder(self.radioButton_times_query_dates_and_client, self.radioButton_times_query_return_all)
        QWidget.setTabOrder(self.radioButton_times_query_return_all, self.radioButton_times_sort_by_date_only)
        QWidget.setTabOrder(self.radioButton_times_sort_by_date_only, self.radioButton_times_sort_by_client_first)
        QWidget.setTabOrder(self.radioButton_times_sort_by_client_first, self.radioButton_times_sort_by_month_then_by_client)
        QWidget.setTabOrder(self.radioButton_times_sort_by_month_then_by_client, self.pushButton_times_run_query)
        QWidget.setTabOrder(self.pushButton_times_run_query, self.pushButton_times_export_query_results)
        QWidget.setTabOrder(self.pushButton_times_export_query_results, self.pushButton_times_overwrite)
        QWidget.setTabOrder(self.pushButton_times_overwrite, self.pushButton_times_delete)
        QWidget.setTabOrder(self.pushButton_times_delete, self.tableView_times_query)
        QWidget.setTabOrder(self.tableView_times_query, self.comboBox_invoices_client_name)
        QWidget.setTabOrder(self.comboBox_invoices_client_name, self.comboBox_invoices_month)
        QWidget.setTabOrder(self.comboBox_invoices_month, self.comboBox_invoices_year)
        QWidget.setTabOrder(self.comboBox_invoices_year, self.lineEdit_invoices_invoice_date)
        QWidget.setTabOrder(self.lineEdit_invoices_invoice_date, self.pushButton_invoices_fill_in_today)
        QWidget.setTabOrder(self.pushButton_invoices_fill_in_today, self.lineEdit_invoices_rate_during_day)
        QWidget.setTabOrder(self.lineEdit_invoices_rate_during_day, self.lineEdit_invoices_rate_for_shifts)
        QWidget.setTabOrder(self.lineEdit_invoices_rate_for_shifts, self.lineEdit_invoices_compensation_for_commute)
        QWidget.setTabOrder(self.lineEdit_invoices_compensation_for_commute, self.lineEdit_invoices_compensation_for_driving_during_work)
        QWidget.setTabOrder(self.lineEdit_invoices_compensation_for_driving_during_work, self.pushButton_generate_invoice)
        QWidget.setTabOrder(self.pushButton_generate_invoice, self.pushButton_invoices_clear_fields)
        QWidget.setTabOrder(self.pushButton_invoices_clear_fields, self.comboBox_invoices_query_start_month)
        QWidget.setTabOrder(self.comboBox_invoices_query_start_month, self.comboBox_invoices_query_start_year)
        QWidget.setTabOrder(self.comboBox_invoices_query_start_year, self.comboBox_invoices_query_stop_month)
        QWidget.setTabOrder(self.comboBox_invoices_query_stop_month, self.comboBox_invoices_query_stop_year)
        QWidget.setTabOrder(self.comboBox_invoices_query_stop_year, self.comboBox_invoices_query_client_name)
        QWidget.setTabOrder(self.comboBox_invoices_query_client_name, self.radioButton_invoices_query_dates_only)
        QWidget.setTabOrder(self.radioButton_invoices_query_dates_only, self.radioButton_invoices_query_client_only)
        QWidget.setTabOrder(self.radioButton_invoices_query_client_only, self.radioButton_invoices_query_dates_and_client)
        QWidget.setTabOrder(self.radioButton_invoices_query_dates_and_client, self.radioButton_invoices_query_return_all)
        QWidget.setTabOrder(self.radioButton_invoices_query_return_all, self.radioButton_invoices_sort_by_date_only)
        QWidget.setTabOrder(self.radioButton_invoices_sort_by_date_only, self.radioButton_invoices_sort_by_client_first)
        QWidget.setTabOrder(self.radioButton_invoices_sort_by_client_first, self.radioButton_invoices_sort_by_month_then_by_client)
        QWidget.setTabOrder(self.radioButton_invoices_sort_by_month_then_by_client, self.pushButton_invoices_run_query)
        QWidget.setTabOrder(self.pushButton_invoices_run_query, self.pushButton_invoices_export_query_results)
        QWidget.setTabOrder(self.pushButton_invoices_export_query_results, self.pushButton_invoices_overwrite)
        QWidget.setTabOrder(self.pushButton_invoices_overwrite, self.pushButton_invoices_delete)
        QWidget.setTabOrder(self.pushButton_invoices_delete, self.tableView_invoices_query)
        QWidget.setTabOrder(self.tableView_invoices_query, self.textBrowser_console)
