...
class Signals(QtCore.QObject):
    ...
    invoices_request_client_code_and_next_invoice_index_at_client_signal = QtCore.Signal(str)
    invoices_deliver_client_code_and_next_invoice_index_at_client_signal = QtCore.Signal(str, int)
