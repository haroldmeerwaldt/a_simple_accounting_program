...
class TimesTab(QtWidgets.QMainWindow):
    add_overwrite_widget_name_list = ['comboBox_times_client_name', 'info_label_times_client_code', 'lineEdit_times_date', 'info_label_day_of_week',
    ...
    query_widget_name_list = ['comboBox_times_query_start_month', 'comboBox_times_query_start_year',
    ...
    def _initialize_combobox_lists(self):
        ...
        self._initialize_time_combobox_lists()
        self._initialize_month_combobox_lists()
        self._initialize_year_combobox_lists()
        self._initialize_type_of_hours_combobox_list()

    def _initialize_time_combobox_lists(self):
    ...
    def _initialize_month_combobox_lists(self):
    ...
    def _initialize_year_combobox_lists(self):
    ...
    def _initialize_type_of_hours_combobox_list(self):
    ...
    def _on_pushbutton_add_working_day_clicked(self):
        try:
            add_working_day_widget_value_dict = self.widgets.get_widget_value_dict(self.add_overwrite_widget_name_list)
    ...
    def _generate_times_query_widget_value_dict(self):
        times_query_widget_value_dict = self.widgets.get_widget_value_dict(self.query_widget_name_list)
    ...
    def _on_tableview_times_query_clicked(self):
        ...
        row_dict = self.widgets.get_tableview_df_row_as_dict('tableView_times_query', current_row)
    ...
    def _on_pushbutton_times_overwrite_clicked(self):
        ...
        try:
            overwrite_working_day_widget_value_dict = self.widgets.get_widget_value_dict(self.add_overwrite_widget_name_list)
            times_query_widget_value_dict = self._generate_times_query_widget_value_dict()
